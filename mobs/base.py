...
class DeathAnimatedMob(Mob):
    def __init__(self, x, bottom, walking_images, death_images, animation_walking_interval, animation_death_interval, speed, ground_left, ground_right):
        super().__init__(speed, ground_left, ground_right)
        
        self.animation_frames = {
            "walking": create_frames(walking_images),
            "death": create_frames(death_images)
        }
        ...
        self.animation_walking_interval = animation_walking_interval
        self.animation_death_interval = animation_death_interval
