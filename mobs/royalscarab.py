...
class RoyalScarab(Mob):
    def __init__(self, x, bottom, speed, ground_left, ground_right):
        super().__init__(speed, ground_left, ground_right)

        self.animation_frames = {
            "walking": create_frames(ROYAL_SCARAB_WALKING_IMAGES),
            "death": create_frames(tuple(pygame.transform.flip(img, False, True) for img in ROYAL_SCARAB_WALKING_IMAGES))
        }
