...
class Bee(Mob):
    def __init__(self, x, bottom, speed, ground_left, ground_right):
        ...
        self.animation_frames = {
            "walking": create_frames(BEE_WALKING_IMAGES),
            "death": create_frames(BEE_DEATH_IMAGES)
        }
        ...
        self.last_animation_flying_time = 0
        self.last_animation_death_time = 0

        self.animation_flying_interval = 200
    ...
    def update_flying_animation(self):
        ...
        if pygame.time.get_ticks() - self.last_animation_flying_time >= self.animation_flying_interval:
            ...
            self.last_animation_flying_time = pygame.time.get_ticks()
