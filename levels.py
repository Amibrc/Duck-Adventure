...
level_2 = Level(
    objects=[
        ...
        StaticObject(2048, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2080, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
        StaticObject(2112, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2144, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
        StaticObject(2176, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2208, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
        StaticObject(2240, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2272, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
        StaticObject(2304, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2336, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
        StaticObject(2368, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2400, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
        StaticObject(2432, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2464, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
        StaticObject(2496, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE), StaticObject(2528, SCREEN_HEIGHT - 70, GREY_BRICK_IMAGE),
                
        StaticObject(2048, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2080, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),
        StaticObject(2112, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2144, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),
        StaticObject(2176, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2208, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),
        StaticObject(2240, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2272, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),
        StaticObject(2304, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2336, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),
        StaticObject(2368, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2400, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),
        StaticObject(2432, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2464, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),
        StaticObject(2496, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE), StaticObject(2528, SCREEN_HEIGHT - 38, GREY_BRICK_IMAGE),

        StaticObject(2048, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2080, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),
        StaticObject(2112, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2144, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),
        StaticObject(2176, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2208, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),
        StaticObject(2240, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2272, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),
        StaticObject(2304, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2336, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),
        StaticObject(2368, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2400, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),
        StaticObject(2432, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2464, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),
        StaticObject(2496, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE), StaticObject(2528, SCREEN_HEIGHT - 6, GREY_BRICK_IMAGE),

        StaticObject(2048, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2080, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),
        StaticObject(2112, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2144, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),
        StaticObject(2176, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2208, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),
        StaticObject(2240, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2272, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),
        StaticObject(2304, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2336, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),
        StaticObject(2368, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2400, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),
        StaticObject(2432, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2464, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),
        StaticObject(2496, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE), StaticObject(2528, SCREEN_HEIGHT + 26, GREY_BRICK_IMAGE),

        StaticObject(2256, SCREEN_HEIGHT - 172, GREY_BRICK_IMAGE), StaticObject(2288, SCREEN_HEIGHT - 172, GREY_BRICK_IMAGE),
        StaticObject(2320, SCREEN_HEIGHT - 172, GREY_BRICK_IMAGE), StaticObject(2352, SCREEN_HEIGHT - 172, GREY_BRICK_IMAGE),
    ],
    mobs=[
        RoyalScarab(208, SCREEN_HEIGHT - 204, 1, 208, 336),
        Bee(502, SCREEN_HEIGHT - 42, -4, 0, 502),
        Slime(960, SCREEN_HEIGHT, -1, 576, 960),
        RoyalScarab(1232, SCREEN_HEIGHT - 204, 1, 1232, 1360),

        Bee(1536, SCREEN_HEIGHT - 10, 6, 1536, 2048),
        Bee(2048, SCREEN_HEIGHT - 40, -6, 1536, 2048),
        Bee(1792, SCREEN_HEIGHT - 70, 6, 1536, 2048),

        RoyalScarab(2256, SCREEN_HEIGHT - 204, 1, 2256, 2384),
        GiantRoyalScarab(2560, SCREEN_HEIGHT - 102, -4, 2048, 2560)
    ],
    coins=[
        ...
        Coin(2272, SCREEN_HEIGHT - 102, 0, 1, 0, 0, SCREEN_HEIGHT - 102, SCREEN_HEIGHT - 134),
        Coin(2320, SCREEN_HEIGHT - 102, 0, 1, 0, 0, SCREEN_HEIGHT - 102, SCREEN_HEIGHT - 134),
        Coin(2368, SCREEN_HEIGHT - 102, 0, 1, 0, 0, SCREEN_HEIGHT - 102, SCREEN_HEIGHT - 134),

        Coin(2272, SCREEN_HEIGHT - 204, 0, 1, 0, 0, SCREEN_HEIGHT - 204, SCREEN_HEIGHT - 236),
        Coin(2320, SCREEN_HEIGHT - 204, 0, 1, 0, 0, SCREEN_HEIGHT - 204, SCREEN_HEIGHT - 236),
        Coin(2368, SCREEN_HEIGHT - 204, 0, 1, 0, 0, SCREEN_HEIGHT - 204, SCREEN_HEIGHT - 236),
    ],
    diamonds=[
        Diamond(16, SCREEN_HEIGHT, 0, 1, 0, 0, SCREEN_HEIGHT, SCREEN_HEIGHT - 40),
        Diamond(1792, SCREEN_HEIGHT, 0, 1, 0, 0, SCREEN_HEIGHT, SCREEN_HEIGHT - 40),
        Diamond(2583, SCREEN_HEIGHT, 0, 1, 0, 0, SCREEN_HEIGHT, SCREEN_HEIGHT - 40),
    ],
    level_size=(2606, SCREEN_HEIGHT),
